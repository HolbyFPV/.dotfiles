return {
    ...
    config = function()
        ...
        vim.keymap.set('n', 'ge', vim.diagnostic.setloclist, { desc = 'Open diagnostics list' })
        ...
        local on_attach = function(_, bufnr)
            ...
            nmap('gU', vim.lsp.buf.references, '[G]oto [R]eferences')
            nmap('gh', vim.lsp.buf.hover, 'Hover Documentation')
            nmap('gp', vim.lsp.buf.signature_help, 'Signature Documentation')

            -- I don't use any of the following maps.  Keeping them for now in case I do.
            ...
            nmap('<leader>p', vim.lsp.buf.format, 'Format Code')
        end
