    ...
    config = function()
        ...
        local default_header = {
            ...
            val = {
                ...
                "." .. tostring(vim.version().minor .. "." .. tostring(vim.version().patch)) .. " │",
                -- "▔▔▔▔▔▔▔▔▔▔▔▔▔▔"
                "╰─────────┴────────╯"
            },
            opts = {
        ...
        local section = {
            ...
            --         button("c", "  Configuration", ":e ~/AppData/Local/nvim/init.lua<CR>"),
            ...
            bottom_buttons = {
                ...
                val = {
                    ...
                    button("t", "󰙅  File Tree", ":NvimTreeToggle<CR>"),
                    button("f", "󰱼  Find file", "<CMD>Telescope find_files<CR>"),
                    button("s", "󰤘  Recently used files", ":Telescope oldfiles <CR>"),
                    button("g", "󱎸  Find text", "<CMD>Telescope live_grep<CR>"),
                    button("c", "  Configuration", ":Lazy<CR>"),
                    button("h", "󰣐  Health", ":checkhealth<CR>"),
                    button("q", "  Quit", ":qa<CR>"),
                },
            },
            footer = {
...
return {
    ...
    --
    -- "    __          ____                       _         ",
    -- "   / /_  ____  / / /_  __  __  ____ _   __(_)___ ___ ",
    -- "  / __ \\/ __ \\/ / __ \\/ / / / / __ \\ | / / / __ `__ \\",
    -- " / / / / /_/ / / /_/ / /_/ / / / / / |/ / / / / / / /",
    -- "/_/ /_/\\____/_/_.___/\\__, (_)_/ /_/|___/_/_/ /_/ /_/ ",
    -- "                    /____/                            "
    ...
    -- "                  |__/                   "
            ...
            " _           _ _                        ▁          ",
            "| |         | | |                      (▁)          ",
            "| |__   ___ | | |__  _   _   _ ____   ___ _ __ ___  ",
            "| '_ \\ / _ \\| | '_ \\| | | | | '_ \\ \\ / / | '_ ` _ \\ ",
            "| | | | (_) | | |_) | |_| |_| | | \\ V /| | | | | | |",
            "|_| |_|\\___/|_╎_.__/ \\__, (_)_| |_|\\_/ |_╎_| |_| |_|",
            "                      __/ |                         ",
            "                     |___/                          "
            -- ".__           .__ ___.                          .__         ",
            -- "|  |__   ____ |  |\\_ |__ ___.__.      _______  _|__| _____  ",
            -- "|  |  \\ /  _ \\|  | | __ <   |  |     /    \\  \\/ /  |/     \\ ",
            -- "|   Y  (  <_> )  |_| \\_\\ \\___  |    |   |  \\   /|  |  Y Y  \\",
            -- "|___|  /\\____/|____/___  / ____| /\\ |___|  /\\_/ |__|__|_|  /",
            -- "     \\/                \\/\\/      \\/      \\/              \\/ "
            --
            -- "██╗  ██╗ ██████╗ ██╗     ██████╗ ██╗   ██╗███╗   ██╗██╗   ██╗██╗███╗   ███╗",
            -- "██║  ██║██╔═══██╗██║     ██╔══██╗╚██╗ ██╔╝████╗  ██║██║   ██║██║████╗ ████║",
